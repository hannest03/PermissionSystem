...
public class AddPermissionSubCommand extends PermissionBaseSubCommand {
  ...
  public AddPermissionSubCommand(Plugin plugin, ServiceRegistry serviceRegistry) {
    super("add", "add <group> <permission>", serviceRegistry, "permission.group.permission.add");
