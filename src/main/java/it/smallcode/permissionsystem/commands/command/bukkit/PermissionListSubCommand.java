...
public class PermissionListSubCommand extends ListSubCommand {

  private static final String OUTPUT_FORMAT = "output_format";

  protected final LanguageService languageService;

  public PermissionListSubCommand(String name, ServiceRegistry serviceRegistry) {
    this(name, serviceRegistry, null);
  }

  public PermissionListSubCommand(String name, ServiceRegistry serviceRegistry, String permission) {
